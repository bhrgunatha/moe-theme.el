...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(isearch ((,class (:foreground ,white-1 :background ,orange-5))))
   `(lazy-highlight ((,class (:background ,magenta-3 :foreground ,white-1))))
   `(trailing-whitespace ((,class (:background ,red-3))))
   `(show-paren-match ((,class (:foreground "white"  :background "saddle brown"))))
   ...
   `(font-lock-comment-delimiter-face ((,class (:foreground ,purple-1-5 :slant italic))))
   `(font-lock-comment-face ((,class (:foreground ,purple-1-5 :slant italic))))
   ...
   `(org-level-5 ((,class (:foreground ,purple-2))))
   `(org-level-6 ((,class (:foreground ,green-3))))
   ...
   `(outline-5 ((,class (:foreground ,purple-2))))
   `(outline-6 ((,class (:foreground ,green-3))))
   ...
   `(markdown-comment-face ((,class (:foreground ,purple-1-5 :italic t))))
   ...
   `(magit-diff-added ((,class (:foreground ,green-2 :background nil :bold t))))
   `(magit-diff-added-highlight ((,class (:foreground ,green-2 :bold t :inherit (magit-section-highlight)))))
   ...
   `(magit-section-highlight ((,class (:background ,black-4))))
   ...
   ;; Rainbow-delimiters
   `(rainbow-delimiters-depth-1-face ((,class (:bold t :foreground "indian red"))))
   ...
   ;; web-mode
   `(web-mode-comment-face ((,class (:foreground ,purple-1-5))))
   ...
   `(web-mode-html-tag-face ((,class (:foreground ,orange-4))))
