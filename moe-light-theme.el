...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   ;; ivy-mode
   `(ivy-current-match ((,class (:foreground ,blue-2 :bold t :inherit highlight))))
   ...
   `(ivy-minibuffer-match-face-1 ((,class (:background ,yellow-00 :foreground ,green-4))))
   ...
   ;; swiper
   `(swiper-match-face-1 ((,class (:background ,yellow-00 :foreground ,green-4))))
   ...
   `(swiper-line-face ((,class (:foreground ,blue-2 :bold t :inherit highlight))))
